...
execute if score @s[scores={ES_fuel=1..}] ES_thrust matches 21..40 run effect give @s minecraft:dolphins_grace 1 4 true
execute if score @s[scores={ES_fuel=1..}] ES_thrust matches 41..60 run effect give @s minecraft:dolphins_grace 1 2 true
execute if score @s[scores={ES_fuel=1..}] ES_thrust matches 61..80 run effect give @s minecraft:dolphins_grace 1 6 true
