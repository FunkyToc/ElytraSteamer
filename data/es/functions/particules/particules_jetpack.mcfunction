...
execute unless score SmokeParticules ES_options matches 2 if score McVersion fktool matches 114.. if entity @s[scores={ES_thrust=1..100}] run function es:particules/passive_1.15
